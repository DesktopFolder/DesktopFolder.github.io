...
#### Important: Although the server may not enforce these rules, they must be followed or your open qualifier submission may not be accepted.

### Draft Settings Rules

- You **must not** set any of the seeds. The seed filter will generate all 3 seeds for you automatically.
- You **may** use any number of gambits. To uncap the amount, set "Max Gambits" to a high value (e.g. 20)
